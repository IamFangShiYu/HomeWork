				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							...
							class="user-info"> <small>欢迎,${name}</small>
			...
			<div class="sidebar" id="sidebar">
			    ...
			    <li><a href="javascript:void(0)" target="mainframe"
						...
						<ul class="submenu">
                            ...
                            <li><a href="${pageContext.request.contextPath}/system/department/list.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 部门管理
							</a></li>
                            <li><a href="${pageContext.request.contextPath }/system/position/list.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 职位管理
							</a></li>
			  ...
			  <li><a href="javascript:void(0)" target="mainframe"
						class="dropdown-toggle"> <i class="icon-desktop"></i> <span
							class="menu-text"> 考勤管理 </span> <b class="arrow icon-angle-down"></b>
					</a>

						<ul class="submenu">
							
                            <li><a href="${pageContext.request.contextPath }/Overtimerecord/list.action" target="mainframe"> <i
									class="icon-double-angle-right"></i> 加班管理
							</a></li>
