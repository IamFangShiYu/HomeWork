...
<form action="${pageContext.request.contextPath}/Overtimerecord/add.action" class="form-horizontal">
	...
	<div class="row">
    	<div class="col-sm-5">
        	<div class="form-group">
                ...
                <div class="col-sm-9">
                	<input type="text" name="overtimeid" readonly="readonly" class="form-control input-sm" placeholder="请输入加班单号"/>
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	   <input type="text" name="overtimedate" onclick="WdatePicker()" readonly="readonly" class="form-control input-sm" placeholder="加班日期"/>
               </div>
            </div>
        </div>
                ...
                <div class="form-group">
					<div class="col-sm-5">
						<select class="form-control input-sm" name="overtimestate">
							<option value="" >请选择</option>
							    <option value="${1}" >需要调休</option>
								<option value="${2}" >无需调休</option>
						</select>
					</div>
				</div>
            </div>
					...
					<div class="col-sm-5">
						<select class="form-control input-sm" name="noteid">
							...
							<c:forEach items="${attNoteslist}" var="attNotes">
								<option value="${attNotes.noteid}" >${attNotes.noteid}</option>
							</c:forEach>
						</select>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-sm-10">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea class="form-control" name="overtimememo"> </textarea>
					</div>
				</div>
